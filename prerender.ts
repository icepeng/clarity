...
const argv = minimist(process.argv.slice(2), {
  default: {
    deploy: false,
    directory: '../../gh-pages/documentation/' + environment.version,
    base: '/clarity-website/documentation/' + environment.version + '/'
  }
});
...
const redirects = () => {
  [
    {from: join(BROWSER_FOLDER, 'datagrid', 'index.html'), to: `${argv.base}/documentation/${environment.version}/datagrid/structure`},
    {from: join(BROWSER_FOLDER, 'vertical-nav', 'index.html'), to: `${argv.base}/documentation/${environment.version}/vertical-nav/basic-structure`},
  ].forEach(file => {
